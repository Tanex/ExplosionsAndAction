...
public class ExplosionsAndActionServerTarget : TargetRules
{
    public ExplosionsAndActionServerTarget(TargetInfo Target)
    {
        ...
        )
    {
        ...
        OutExtraModuleNames.Add("ExplosionsAndAction");
    }
